...
load_from = 'work_dirs/isaid/base_training/split1/r101_fpn_fsd_isaid-split1_base-training-0/iter_80000_novel.pth'
...
work_dir = 'work_dirs/isaid/finetune/split2/finetune_r101_fpn_fsd_isaid-split2_1shot-tfa-sep-0'
gpu_ids = range(0, 2)