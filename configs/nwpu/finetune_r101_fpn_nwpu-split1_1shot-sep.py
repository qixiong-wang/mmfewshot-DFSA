...
log_level = 'INFO'
load_from = 'work_dirs/nwpu/base_training/tfa_r101_fpn_nwpu-split1_base-training_resize-bs8-s4-0/iter_20000_sep_novel.pth'
resume_from = None
workflow = [('train', 1)]
use_infinite_sampler = False
seed = 42
work_dir = 'work_dirs/nwpu/finetune/finetune_r101_fpn_nwpu-split1_1shot-sep-0'
gpu_ids = range(0, 1)
