...
import os
classes = ('bridge', 'harbor', 'ground track field', 'ship', 'storage tank', 
...
def _get_xml_ann_info(img_id: str):
        ...
        xml_path = osp.join('/home/jianghx/data/NWPU_VHR_10_VOC', 'Annotations',
                            f'{img_id}.xml')
...
for png_name in os.listdir('/home/jianghx/data/NWPU_VHR_10_VOC/JPEGImages'):
    # if png_name != '00008.jpg':
    #     continue
    png = cv2.imread(os.path.join('/home/jianghx/data/NWPU_VHR_10_VOC/JPEGImages', png_name))
    ...
    cv2.imwrite('/home/jianghx/data/nwpu/Output/gt/{}'.format(png_name), png)